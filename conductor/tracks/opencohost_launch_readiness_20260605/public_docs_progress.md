...
```powershell
python -m pytest tests/test_runtime_smoke_harness.py tests/test_kira_orchestration_gaps.py tests/test_llm_engine_timeouts.py tests/test_streaming_speech_pipeline.py tests/test_sentence_splitter.py -q
```
